 ...
 *   DEMO_TOKEN is set as a Cloudflare Worker secret (not stored in code).
 *   Run: wrangler secret put DEMO_TOKEN
 *
...
export default {
  async fetch(request, env) {
    ...
    const expected   = `Bearer ${env.DEMO_TOKEN}`;
    if (!env.DEMO_TOKEN || authHeader !== expected) {
